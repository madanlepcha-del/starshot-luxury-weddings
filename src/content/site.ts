...
export const home = {
  ...
  aboutPreview: {
    eyebrow: "About Starshots",
    title: "A storyteller behind the lens",
    paragraphs: [
      "Starshots is a Sydney-based wedding photography studio devoted to capturing genuine emotion, natural moments, and the quiet beauty of a love that's entirely your own.",
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "Starshots captured our wedding day with such artistry and grace. Every photograph feels like a film still — we will treasure them forever.",
        author: "Olivia & James",
...
export const about_page = {
  ...
  story: {
    ...
    paragraphs: [
      "Starshots began with a simple belief: a wedding day is best remembered through the small, unscripted moments — the laughter shared, the held breath before vows, the warmth of a quiet glance.",
