    ...
    <footer className="bg-charcoal text-ivory">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-20 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 space-y-5">
          <p className="font-serif text-3xl tracking-[0.35em]">STARSHOTS</p>
        ...
        <div className="space-y-4">
          ...
          <a href="mailto:hello@starshots.studio" className="flex items-center gap-2 text-sm text-ivory/80 hover:text-champagne transition">
            <Mail size={15} /> hello@starshots.studio
          </a>
      ...
      <div className="border-t border-ivory/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 flex flex-col md:flex-row justify-between gap-3 text-xs text-ivory/50">
          <p>© {new Date().getFullYear()} Starshots Photography. All rights reserved.</p>
