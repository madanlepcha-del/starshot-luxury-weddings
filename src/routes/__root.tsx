...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Starsshot — Sydney Wedding Photography" },
      { name: "description", content: "Luxury, romantic wedding photography in Sydney, Australia." },
      { name: "author", content: "Starsshot" },
      { property: "og:title", content: "Starsshot — Sydney Wedding Photography" },
      { property: "og:description", content: "Luxury, romantic wedding photography in Sydney, Australia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Starsshot — Sydney Wedding Photography" },
