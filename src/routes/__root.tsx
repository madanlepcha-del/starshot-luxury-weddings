...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Starshots — Sydney Wedding Photography" },
      { name: "description", content: "Luxury, romantic wedding photography in Sydney, Australia." },
      { name: "author", content: "Starshots" },
      { property: "og:title", content: "Starshots — Sydney Wedding Photography" },
      { property: "og:description", content: "Luxury, romantic wedding photography in Sydney, Australia." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Starshots — Sydney Wedding Photography" },
